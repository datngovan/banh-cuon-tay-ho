      ...
      <div className="pt-20 text-center font-bold text-primary-50 text-2xl">
        THỰC ĐƠN
            ...
            <div className="grid grid-cols-3 items-center justify-around md:mt-10 md:p-10 m-2 p-2">
                <TabButtons name="TẤT CẢ" id="all" value="TẤT CẢ" link="/thuc-don/">TẤT CẢ</TabButtons>  
                <TabButtons name="BÁNH MẶN" id="nonVegetarian" link="/thuc-don/mon-man" value="BÁNH MẶN">BÁNH MẶN</TabButtons>
                <TabButtons name="BÁNH CHAY" id="Vegetarian" link="/thuc-don/mon-chay" actived="true" value="BÁNH CHAY">BÁNH CHAY</TabButtons>
            </div>
    </div>
    <div>
