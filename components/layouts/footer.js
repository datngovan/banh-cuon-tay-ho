    ...
    return (
        <>
          <div
            ...
            className="w-full pt-auto h-96 pl-5 flex flex-col md:flex-row md:items-center md:justify-between md:h-56 md:px-14"
          >
           <div className="flex justify-center">
           <Image
              alt="banh cuon tay ho logo"
            ...
            <div className="my-5 md:my-0 md:mt-12">
              <p style={{ color: "#a11b1b" }} className="font-bold flex justify-center">
                MUA NGAY TẠI
              </p>
